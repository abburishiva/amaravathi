                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="form-group">
                                <label htmlFor="skills">Skills you are looking for?</label>
                                <ReactTags
                                    tags={props.skills}
                        ...
                        <div className="col-md-4">
                            <div className="form-group">
                                ...
                                <input type="date" name="dateRequired" onChange={props.handleOnChange} value={props.dateRequired} className="form-control" id="date" />
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="form-group">
                                <label htmlFor="availability">How often you need a sahayak?</label>
                                <select name="availability" value={props.availability} onChange={props.handleOnChange} className="form-control" id="availability">
                        ...
                        <div className="col-md-12">
                            <div className="form-group">
                                <label htmlFor="comment">Explain help required:</label>
