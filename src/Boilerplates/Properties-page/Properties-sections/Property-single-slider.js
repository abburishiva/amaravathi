...
export default class PropertySingleSlider extends Component {
    render() {
        return (
            <div className="property-=single-slider">
                <Header />
                <section className="osahan-slider">
                    <div id="osahanslider" className="carousel slide" data-ride="carousel">
                        ...
                        <div className="carousel-inner" role="listbox">
                            ...
                            <div className="carousel-item" id="property1">
                                <div className="overlay"></div>
                            </div>
                        </div>
                    ...
                    <div className="property-single-title">
                        <div className="container">
                            <div className="row">
                                <div className="col-lg-8 col-md-8">
                                    <h1 className="text-white">House in Kent Street</h1>
                                    <h6 className="text-white"><i className="mdi mdi-home-map-marker"></i> 250-260 3rd St, Hoboken, NJ 07030, USA</h6>
                                </div>
                                <div className="col-lg-4 col-md-4 text-right">
                                    <h6 className="text-white mt-2">For Rent</h6>
                            ...
                            <div className="row">
                                <div className="col-lg-8 col-md-8">
                                    <p className="mt-1 mb-0 text-white"><strong>Property ID</strong> : 533566 &nbsp;&nbsp; <strong>Add to favorites</strong> <i className="mdi mdi-heart text-white"></i></p>
                                </div>
                                <div className="col-lg-4 col-md-4 text-right">
