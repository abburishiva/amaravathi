                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 text-center">
                                <h1 className="mt-0 mb-3 text-white">My Properties</h1>
                                <div className="breadcrumbs">
                                    <p className="mb-0 text-white"><a className="text-white" href="index.html">Home</a>  /  <span className="text-success">My Properties</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div className="row no-gutters">
                                                    ...
                                                    <div className="col-lg-7 col-md-7">
                                                        <div className="card-body">
                                                            <span className="float-right text-success"><i className="mdi mdi-table-edit"></i> Edit</span>
                                            ...
                                            <a href="index.html">
                                                <div className="row no-gutters">
                                                    <div className="col-lg-5 col-md-5">
                                                        ...
                                                        <img className="card-img-top" src={require('../img/list/5.png')} alt="" />
                                                    </div>
                                                    <div className="col-lg-7 col-md-7">
                                                        <div className="card-body">
                                                            <span className="float-right text-success"><i className="mdi mdi-table-edit"></i> Edit</span>
                                            ...
                                            <a href="index.html">
                                                <div className="row no-gutters">
                                                    <div className="col-lg-5 col-md-5">
                                                        ...
                                                        <img className="card-img-top" src={require('../img/list/6.png')} alt="" />
                                                    </div>
                                                    <div className="col-lg-7 col-md-7">
                                                        <div className="card-body">
                                                            <span className="float-right text-success"><i className="mdi mdi-table-edit"></i> Edit</span>
